...
<html class="no-js" lang="en" dir="ltr">
    <head>
        ...
        <title>
  @yield('title','Mckey Shirts')
        </title>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"/>
        <link rel="stylesheet" href="public/dist/css/foundation.css"/>
...
<footer class="footer">
  <div class="row full-width">
    ...
    <script src="public/dist/js/vendor/jquery.js"></script>
    <script src="public/dist/js/app.jss"></script>
    </body>
</html>
